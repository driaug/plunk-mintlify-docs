...
When you are creating a new template, you can use the `{{data}}` variable to access the metadata. For example, if you wanted to use the name of the project in your template, you could use `{{project}}`.
